export const en = {
    ...
    home: {
        heroTitle: "Precision at<br />Your Fingertips",
        heroDesc: "The most accurate online ruler for your browser. Calibrate once, measure anything. Perfect for quick measurements on any screen size.",
        startMeasuring: "Start Measuring",
        howItWorks: "How it Works",
        features: {
            accuracy: {
                title: "Calibrated for Accuracy",
                desc: "Easily calibrate using a standard card or custom object to be used on any display."
            },
            units: {
                title: "Multi-Unit Support",
                desc: "Switch seamlessly between Centimeters and Inches with a single click."
            },
            mobile: {
                title: "Mobile Ready",
