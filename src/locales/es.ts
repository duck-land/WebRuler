export const es = {
    ...
    home: {
        heroTitle: "Precisión al<br />Alcance de tu Mano",
        heroDesc: "La regla en línea más precisa para tu navegador. Calibra una vez, mide cualquier cosa. Perfecta para mediciones rápidas en cualquier tamaño de pantalla.",
        startMeasuring: "Empezar a Medir",
        howItWorks: "Cómo Funciona",
        features: {
            accuracy: {
                title: "Calibrada para Precisión",
                desc: "Calibra fácilmente usando una tarjeta estándar u objeto personalizado para usar en cualquier pantalla."
            },
            units: {
                title: "Soporte Multi-unidad",
                desc: "Cambia sin problemas entre Centímetros y Pulgadas con un solo clic."
            },
            mobile: {
    ...
    contact: {
        title: "Contáctenos",
        desc: "Si tiene alguna pregunta o comentario, no dude en contactarnos.",
