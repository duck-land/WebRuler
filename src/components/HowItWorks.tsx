...
import { FaCreditCard, FaDesktop, FaExpandArrowsAlt, FaSlidersH } from 'react-icons/fa';
...
export default function HowItWorks() {
    ...
    return (
        <section id="how-it-works" className="container" style={{ padding: '6rem 0', scrollMarginTop: '80px' }}>
